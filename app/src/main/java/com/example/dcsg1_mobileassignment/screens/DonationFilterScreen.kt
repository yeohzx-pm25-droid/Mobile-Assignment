...
fun DonationFilterScreen(navController: NavController) {
    ...
    Column(
        ...
        DonationFilterTopBar(
            onBack = { navController.popBackStack() },
            onReset = {
                category = JOB_FILTER_ALL
        ...
        Column(
            ...
            Text(
                text = "Narrow donations by category and location.",
            ...
            DonationFilterSection(title = "Category") {
                DonationChipGroup(
                    options = listOf(JOB_FILTER_ALL) + CommunityData.donationCategories,
                    selected = category,
            ...
            DonationFilterSection(title = "Location") {
            ...
            Button(
                onClick = {
                    CommunityPostStore.donationCategoryFilter = category
                    CommunityPostStore.donationStateFilter = state
...
@Composable
private fun DonationFilterTopBar(onBack: () -> Unit, onReset: () -> Unit) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .height(90.dp)
...
@Composable
private fun DonationFilterSection(title: String, content: @Composable () -> Unit) {
    Column {
...
@Composable
private fun DonationDropdownField(
    label: String,
    value: String,
    options: List<String>,
    onSelected: (String) -> Unit
